...
public class MyAgent_LUT extends AdvancedRobot {
    ...
    private final double immediate_bonus = 0.5; // rewards
    private final double terminal_bonus = 1.0;
    private final double immediate_penalty = -0.1;
    private final double terminal_penalty = -0.2;
    private final double start_decay_round = 1;
    private final double end_decay_round = 1000;
//    private final double decay_rate = 0.9988;
    private final double initial_epsilon = 0.2;
